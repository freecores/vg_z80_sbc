...
--
-- For defines see vg_z80.defines
--
...
--   wbs_mmu
--     baseadr 0xF00000 - size 0x100000
--   wbs_vga
...
entity intercon is
  ...
  wb_cpu_ctrl_adr_i : out std_logic_vector(7 downto 2);
  ...
  wbs_mmu_adr_i : out std_logic_vector(9 downto 0);
  ...
  wb_uart0_adr_i : out std_logic_vector(4 downto 2);
...
decoder:block
begin
wb32_pci_master_wb_cpu_ctrl_ss <= '1' when wb32_pci_master_adr_o(23 downto 8)="0000000000000010" else 
'0';
...
'0';
wb32_pci_master_wbs_mmu_ss <= '1' when wb32_pci_master_adr_o(23 downto 20)="1111" else 
'0';
wb32_pci_master_wbs_vga_ss <= '1' when wb32_pci_master_adr_o(23 downto 20)="0110" else 
'0';
wb32_pci_master_wb_uart0_ss <= '1' when wb32_pci_master_adr_o(23 downto 5)="0000000000000000111" else 
'0';
wb32_pci_master_wb_uart1_ss <= '1' when wb32_pci_master_adr_o(23 downto 5)="0000000000000000000" else 
'0';
wbm_z80_wb_cpu_ctrl_ss <= '1' when wbm_z80_adr_o(23 downto 8)="0000000000000010" else 
'0';
...
'0';
wbm_z80_wbs_mmu_ss <= '1' when wbm_z80_adr_o(23 downto 20)="1111" else 
'0';
wbm_z80_wbs_vga_ss <= '1' when wbm_z80_adr_o(23 downto 20)="0110" else 
'0';
wbm_z80_wb_uart0_ss <= '1' when wbm_z80_adr_o(23 downto 5)="0000000000000000111" else 
'0';
wbm_z80_wb_uart1_ss <= '1' when wbm_z80_adr_o(23 downto 5)="0000000000000000000" else 
'0';
wb_cpu_ctrl_adr_i <= (wb32_pci_master_adr_o(7 downto 2) and wb32_pci_master_wb_cpu_ctrl_bg) or (wbm_z80_adr_o(7 downto 2) and wbm_z80_wb_cpu_ctrl_bg);
...
wbs_mmu_adr_i <= (wb32_pci_master_adr_o(9 downto 0) and wb32_pci_master_wbs_mmu_bg) or (wbm_z80_adr_o(9 downto 0) and wbm_z80_wbs_mmu_bg);
...
wb_uart0_adr_i <= (wb32_pci_master_adr_o(4 downto 2) and wb32_pci_master_wb_uart0_bg) or (wbm_z80_adr_o(4 downto 2) and wbm_z80_wb_uart0_bg);
...
wbm_z80_ack_i <= (wb_cpu_ctrl_ack_o and wbm_z80_wb_cpu_ctrl_bg) or (wb_sram_ack_o and wbm_z80_wb_sram_bg) or (wbs_flash_ack_o and wbm_z80_wbs_flash_bg) or (wbs_ddr_ack_o and wbm_z80_wbs_ddr_bg) or (wbs_mmu_ack_o and wbm_z80_wbs_mmu_bg) or (wbs_vga_ack_o and wbm_z80_wbs_vga_bg) or (wb_uart0_ack_o and wbm_z80_wb_uart0_bg) or (wb_uart1_ack_o and wbm_z80_wb_uart1_bg);
-- rty_i(s)
-- err_i(s)
...
wbm_z80_dat_i <= (wb_cpu_ctrl_dat_o and wbm_z80_wb_cpu_ctrl_bg) or (wb_sram_dat_o and wbm_z80_wb_sram_bg) or (wbs_flash_dat_o and wbm_z80_wbs_flash_bg) or (wbs_ddr_dat_o and wbm_z80_wbs_ddr_bg) or (wbs_mmu_dat_o and wbm_z80_wbs_mmu_bg) or (wbs_vga_dat_o and wbm_z80_wbs_vga_bg) or (wb_uart0_dat_o and wbm_z80_wb_uart0_bg) or (wb_uart1_dat_o and wbm_z80_wb_uart1_bg);
-- tgc_i
-- tga_i
end rtl;